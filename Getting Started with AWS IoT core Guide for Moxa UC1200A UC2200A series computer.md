# Getting Started with AWS IoT core Guide for Moxa UC-1200A/UC-2200A series computer
...
The standard shipping Moxa UC-1200A/UC-2200A series computer package contains the following items:
